...
Disclaimer: You MAY or SHOULD chose to use the [IP2GEOComments-Incidents Playbooks](https://github.com/Cyberlorians/Sentinel/blob/main/Playbooks/IP2GEOComments-Incident.json)
...
Disclaimer: Again, you may chose to use the [IP2GEOComments-Incidents Playbooks](https://github.com/Cyberlorians/Sentinel/blob/main/Playbooks/IP2GEOComments-Incident.json), here as well with the same type of setup. Just make sure it is connected with the managed identity and the api is ready to roll.
...
To sum this all up. You now have IP2GEOComments which will auto run when an incident triggers AND you now have the ability to run Get-VirusTotalIPReport for FREE. Disclaimer: you can run the Virus Total playbook on any investigation of your choice now. 

Lets head to Part-5
## [Continue to Part-5: Malicious traffic in Sentinel - Summary Rules](https://github.com/Cyberlorians/Articles/blob/main/MaliciousActivityandSentinelP5.md) ##
