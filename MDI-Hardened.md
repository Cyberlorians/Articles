...
2. Additional Configuration for LDAP Search Event ID 1644, [here]](https://docs.microsoft.com/en-us/defender-for-identity/configure-windows-event-collection#event-id-8004). What is Event ID 1644? See [here](https://docs.microsoft.com/en-us/troubleshoot/windows-server/identity/ldap-queries-run-slowly). *Disclaimer* - I would add this registry setting to the OS based hardened GPO so that it gets added to ALL Domain Controllers. See image below.
