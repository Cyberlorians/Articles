# SC-200 / Microsoft Security Study Guide
## Generated Question Bank (65 Questions)

> ⚠️ Note:
> Some questions were sourced from images and may be missing full context.
> These are clearly marked as: `⚠️ Partial (Image-Based)`
...
Duplicate of Question 5 (hash-based detection query)
...
Copilot for Security session sharing scenario.

User2 does NOT have access to Intune.

Which prompts can User2 view?
...
Defender for Cloud services selection (DevOps + Resource Manager)
...
KQL / detection query scenario.

**Answer:** SHA256 mapping (where + join)

---

## Question 14

Custom detection rule KQL summarization

**Answer:** arg_max with Timestamp + ReportId
...
**Answer:** Based on selected image answers (context missing)
