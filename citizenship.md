...
4. Your setup should look similar to the example below:  
   ![](https://github.com/Cyberlorians/uploadedimages/blobr the **Compose** action, click **+ New step**.
...
6. Your setup should look similar to the example below:  
   ![](https://github.com/Cyberlorians/uploadedimagest, you’ll continue building out your Logic App and set permissions as needed.
