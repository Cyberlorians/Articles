...
As of now, there is no Sentinel connector option for Microsofts XDR Threat Vulnerability Management Data to ingest into Sentinel. Since the release of my LogicApp, which works flawless for smaller orgs - there are limitations. Working alongside with two other colleagues they  had exposed me to Data Factory.
